...
var levels = [
	...
	{"number": 2, "distance": 2500, "message": "Oh, you actually survived? How... *amusing.* Level 2 is behind you, but I promise, your luck won't last."},
	{"number": 3, "distance": 3500, "message": "Still breathing? Pathetic. Level 3 falls, yet you remain nothing more than a fool dancing in my shadow."},
...
var dialogue_tracks = {
	"level1": "res://assets/dialogue/level1.mp3",
	"level2": "res://assets/dialogue/level2.mp3",
	"level3": "res://assets/dialogue/level3.mp3",
	"level4": "res://assets/dialogue/level4.mp3",
	"level5": "res://assets/dialogue/level5.mp3",
	"presse": "res://assets/dialogue/presse.mp3"
}
var dialogue_played = {
	"level1": false,
	"level2": false,
...
func _setup_audio():
	...
	dialogue_player.process_mode = Node.PROCESS_MODE_ALWAYS
...
func _game_completed():
	...
	await tween.finished
func _play_dialogue(dialogue_key: String):
	if dialogue_played.has(dialogue_key) and dialogue_played[dialogue_key]:
		return
	if not dialogue_tracks.has(dialogue_key):
		print("Dialogue track not found: ", dialogue_key)
		return
	var audio_path = dialogue_tracks[dialogue_key]
